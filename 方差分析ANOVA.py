...
pivot=pd.pivot_table(dc_sales,index=['pixel'],columns=['market'],values=['sales'],aggfunc='sum')
print(pivot)
...
print(dc_sales_anova)            #P-value<0.05   拒絕均值相等假設(不同因素之間有顯著差異)
#reject:True  差異顯著
#%%多重比較檢驗
#兩兩對比 檢查哪種影響較大   #reject=True有顯著差異
from statsmodels.stats.multicomp import pairwise_tukeyhsd
